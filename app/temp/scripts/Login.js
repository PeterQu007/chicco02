...
/***/ (function(module, exports, __webpack_require__) {
	...
	var loginCL = new _Login2.default(console, 0); //Auto Login Page
	//
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //Login Module
	...
	var Login = function () {
	        function Login(console, debug) {
	                ...
	                this.loginButton = (0, _jquery2.default)('button.accountform-btn:first');
	                this.email = (0, _jquery2.default)('#inputEmailHandle');
	                this.password = (0, _jquery2.default)('#inputPassword');
	        ...
	        _createClass(Login, [{
	                ...
	                value: function checkComplete() {
	                        ...
	                        _$(this);
	                        _$((0, _jquery2.default)(this.loginButton));

	                        if (this.loginButton) {

	                                _$((0, _jquery2.default)('#inputEmailHandle').val());
